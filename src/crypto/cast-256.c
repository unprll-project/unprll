...
/* NOTE: Certain changes have been made for interoperability with RNJC: */
/* 1) Function names have been updated to avoid confusion               */
/* 2) Certain code changes for standard int types and threads           */
/*    (marked with // RNJC)                                      */
